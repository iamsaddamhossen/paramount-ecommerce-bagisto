                    ...
                    <?php $__currentLoopData = $customAttributeValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <?php if($attribute['type'] == 'file' && $attribute['value']): ?>
                                <td>
                                    <a  href="<?php echo e(route('shop.product.file.download', [$product->product_id, $attribute['id']])); ?>" style="color:black;">
...
<?php echo view_render_event('bagisto.shop.products.view.attributes.after', ['product' => $product]); ?><?php /**PATH /home/shuvobeb/public_html/velocity/resources/themes/velocity/views/products/view/attributes.blade.php ENDPATH**/ ?>