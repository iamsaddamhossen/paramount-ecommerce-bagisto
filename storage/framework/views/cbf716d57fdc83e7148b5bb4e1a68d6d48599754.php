                    ...
                    <accordian :title="'<?php echo e(__('admin::app.catalog.families.general')); ?>'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group" :class="[errors.has('code') ? 'has-error' : '']">
                                <input type="text" v-validate="'required'" name="code" class="control" id="code" value="<?php echo e(old('code') ?: $attributeFamily->code); ?>" disabled="disabled" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.families.code')); ?>&quot;" v-code/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velocity_new_app\packages\Webkul\Admin\src\Providers/../Resources/views/catalog/families/edit.blade.php ENDPATH**/ ?>