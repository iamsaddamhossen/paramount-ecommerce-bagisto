            ...
            <div class="account-head">
                ...
                <?php if($order->canCancel()): ?>
                    <span class="account-action">
                        <a href="<?php echo e(route('customer.orders.cancel', $order->id)); ?>" class="theme-btn light unset pull-right" v-alert:message="'<?php echo e(__('shop::app.customer.account.order.view.cancel-confirm-msg')); ?>'" style="float: right">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velocity_new_app/resources/themes/velocity/views/customers/account/orders/view.blade.php ENDPATH**/ ?>