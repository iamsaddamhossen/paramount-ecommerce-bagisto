...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/x-template" id="product-image-template">
        <div>
            ...
            <label class="btn btn-lg btn-primary" style="display: inline-block; width: auto" @click="createFileType">
                <?php echo e(__('admin::app.catalog.products.add-image-btn-title')); ?>
    ...
    <script>
        Vue.component('product-image', {
            ...
            data: function() {
                return {
                    images: <?php echo json_encode($product->images, 15, 512) ?>,
...
<?php $__env->stopPush(); ?><?php /**PATH /home/shuvobeb/public_html/velocity/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/products/accordians/images.blade.php ENDPATH**/ ?>