        ...
        <div class="coupon-container">
            <div class="discount-control">
                <form class="custom-form" method="post" @submit.prevent="applyCoupon">
                    ...
                    <button class="theme-btn light" :disabled="disable_button"><?php echo e(__('shop::app.checkout.onepage.apply-coupon')); ?></button>
                </form>
            </div>
        ...
        Vue.component('coupon-component', {
            ...
            data: function() {
                return {
                    coupon_code: '',
                    error_message: '',
                    applied_coupon: "<?php echo e($cart->coupon_code); ?>",
                    route_name: "<?php echo e(request()->route()->getName()); ?>",
                    disable_button: ("<?php echo e($cart->coupon_code); ?>" == "" ? false : true),
                }
            },
            ...
            methods: {
                ...
                removeCoupon: function () {
                    ...
                    axios.delete('<?php echo e(route('shop.checkout.coupon.remove.coupon')); ?>')
...
<?php endif; ?><?php /**PATH /home/shuvobeb/public_html/velocity/resources/themes/velocity/views/checkout/cart/coupon.blade.php ENDPATH**/ ?>