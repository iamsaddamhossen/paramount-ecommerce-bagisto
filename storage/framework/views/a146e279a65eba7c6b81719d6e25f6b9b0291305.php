                        ...
                        <div class="col-lg-12 col-xl-6">
                            ...
                            <?php for($i = 5; $i >= 1; $i--): ?>
                                ...
                                <div class="row">
                                    ...
                                    <span class="col-2 no-padding fs16"><?php echo e($percentageRatings[$i]); ?> %</span>
                                </div>
                            <?php endfor; ?>
...
<?php echo view_render_event('bagisto.shop.products.review.after', ['product' => $product]); ?><?php /**PATH /home/shuvobeb/public_html/velocity/resources/themes/velocity/views/products/view/reviews.blade.php ENDPATH**/ ?>