    ...
    <accordian :title="'<?php echo e(__('shop::app.checkout.onepage.summary')); ?>'" :active="true">
        ...
        <div slot="body">
            <div class="address-summary row">
                ...
                <?php if($cart->haveStockableItems() && $shippingAddress = $cart->shipping_address): ?>
...
</div><?php /**PATH /home/shuvobeb/public_html/velocity/resources/themes/velocity/views/checkout/onepage/review.blade.php ENDPATH**/ ?>