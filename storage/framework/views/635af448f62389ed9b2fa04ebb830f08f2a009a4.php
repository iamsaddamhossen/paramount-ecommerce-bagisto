                    ...
                    <accordian :title="'<?php echo e(__('admin::app.account.general')); ?>'" :active="true">
                        <div slot="body">
                            ...
                            <div class="control-group">
                                ...
                                <textarea  class="control" disabled> <?php echo e($review->comment); ?></textarea>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velocity_new_app\packages\Webkul\Admin\src\Providers/../Resources/views/customers/reviews/edit.blade.php ENDPATH**/ ?>