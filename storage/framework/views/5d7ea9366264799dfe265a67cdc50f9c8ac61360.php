     ...
     <div class="dropdown">
        ...
        <div class="welcome-content pull-right" @click="togglePopup">
            ...
            <div class="welcome-content pull-right">
                <span class="text-center">
                <div>
                    <a href="<?php echo e(route('customer.session.index')); ?>" style="font-weight: 500; background-color: #fff !important;color: #000 !important;padding: 0 !important;">
                    <?php echo e(__('shop::app.header.sign-in')); ?>

                    </a>
                </div> 
                <div style="padding-left: 20px !important;">
                    <a href="<?php echo e(route('customer.register.index')); ?>" style="font-weight: 500; background-color: #fff !important;color: #000 !important;padding: 0 !important;">
...
<?php /**PATH D:\Old Files\Office Job\paramount-local-ecommerce/resources/themes/velocity/views/layouts/top-nav/login-section.blade.php ENDPATH**/ ?>