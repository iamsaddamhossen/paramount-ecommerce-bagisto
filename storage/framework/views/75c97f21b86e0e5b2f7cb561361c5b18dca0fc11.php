...
<?php $__env->startSection('page-detail-wrapper'); ?>
    <div class="account-head mb-0">
        ...
        <!-- <span class="account-action">
            <a href="<?php echo e(route('customer.profile.edit')); ?>" class="theme-btn light unset pull-right">
    ...
    <div class="account-table-content profile-page-content">
        ...
        <button
            type="submit"
            class="" >
            <a href="<?php echo e(route('customer.profile.edit')); ?>" class="theme-btn light unset pull-right" style="border: none !important;">
                <?php echo e(__('shop::app.customer.account.profile.index.edit')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velocity_new_app/resources/themes/velocity/views/customers/account/profile/index.blade.php ENDPATH**/ ?>