            ...
            <div class="payment-methods" slot="body">
                <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row col-12">
                        <div>
                            <label class="radio-container" style="position: relative;">
                                <input
                                    type="radio"
                                    name="payment[method]"
                                    v-validate="'required'"
...
</form><?php /**PATH C:\xampp\htdocs\velocity_new_app/resources/themes/velocity/views/checkout/onepage/payment.blade.php ENDPATH**/ ?>