    ...
    <script type="text/x-template" id="toolbar-template">
        <div class="toolbar-wrapper" v-if='!isMobile()'>
            <div class="view-mode">
                ...
                <div class="rango-view-list-container <?php echo e($viewOption === 'list' ? 'active' : ''); ?>">
                    <a
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/shuvobeb/public_html/velocity/resources/themes/velocity/views/products/list/toolbar.blade.php ENDPATH**/ ?>