                ...
                <table>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(__('admin::app.catalog.products.qty')); ?></th>
                            <th><?php echo e(__('admin::app.catalog.products.price')); ?></th>
                            <th class="actions"></th>
                        </tr>
                    </thead>
        ...
        <tr>
            ...
            <td>
                <div class="control-group" :class="[errors.has(inputName + '[qty]') ? 'has-error' : '']">
                    <input type="number" v-validate="'required|min_value:0'" :name="[inputName + '[qty]']" v-model="customerGroupPrice.qty" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.catalog.products.qty')); ?>&quot;"/>
            ...
            <td>
                ...
                <div class="control-group">
                    <div class="control-group" :class="[errors.has(inputName + '[value]') ? 'has-error' : '']">
                        <input type="number" v-validate="'required|min_value:0'" :name="[inputName + '[value]']" v-model="customerGroupPrice.value" class="control" data-vv-as="&quot;<?php echo e(__('admin::app.datagrid.price')); ?>&quot;"/>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/shuvobeb/public_html/velocity/packages/Webkul/Admin/src/Providers/../Resources/views/catalog/products/accordians/customer-group-price.blade.php ENDPATH**/ ?>