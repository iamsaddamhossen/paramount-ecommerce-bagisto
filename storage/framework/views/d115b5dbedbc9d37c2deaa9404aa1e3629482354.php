    ...
    <script type="text/x-template" id="checkout-template">
        <div class="container">
            <div id="checkout" class="checkout-process row offset-lg-1 col-lg-11 col-md-12">
                ...
                <h1 class="col-12"><?php echo e(__('velocity::app.checkout.checkout')); ?></h1>
                ...
                methods: {
                    ...
                    isCustomerExist: function() {
                        ...
                        .then(isValid => {
                            ...
                            this.$http.post("<?php echo e(route('customer.checkout.exist')); ?>", {email: this.address.billing.email})
                            .then(response => {
                    ...
                    loginCustomer: function () {
                        this.$http.post("<?php echo e(route('customer.checkout.login')); ?>", {
                                email: this.address.billing.email,
                                password: this.address.billing.password
                            })
                            .then(response => {
                                if (response.data.success) {
                                    window.location.href = "<?php echo e(route('shop.checkout.onepage.index')); ?>";
                                } else {
                    ...
                    placeOrder: function () {
                        if (this.isPlaceOrderEnabled) {
                            ...
                            .catch(error => {
                                ...
                                window.showAlert(`alert-danger`, this.__('shop.general.alert.danger'), "<?php echo e(__('shop::app.common.error')); ?>");
                            })
                        } else {
                            this.disable_button = true;
                        }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/shuvobeb/public_html/velocity/resources/themes/velocity/views/checkout/onepage.blade.php ENDPATH**/ ?>