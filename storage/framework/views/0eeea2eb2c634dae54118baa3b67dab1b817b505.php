    ...
    <div class="account-head">
        ...
        <?php if(! $addresses->isEmpty()): ?>
            <span class="account-action">
                <a href="<?php echo e(route('customer.address.create')); ?>" class="theme-btn light unset pull-right">
                    <?php echo e(__('shop::app.customer.account.address.index.add')); ?>
...
<?php echo $__env->make('shop::customers.account.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velocity_new_app/resources/themes/velocity/views/customers/account/address/index.blade.php ENDPATH**/ ?>