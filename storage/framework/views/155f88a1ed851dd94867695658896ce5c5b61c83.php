...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/x-template" id="cart-rule-template">
        <div>
            <form method="POST" action="<?php echo e(route('admin.cart-rules.store')); ?>" @submit.prevent="onSubmit">
                <div class="page-header">
                    <div class="page-title">
                        <h1>
                            <i class="icon angle-left-icon back-link"
                            onclick="history.length > 1 ? history.go(-1) : window.location = '<?php echo e(route('admin.dashboard.index')); ?>';"></i>
                            ...
                            <div slot="body">
                                ...
                                <div v-if="parseInt(coupon_type)">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <input class="control" id="uses_per_coupon" name="uses_per_coupon" value="<?php echo e(old('uses_per_coupon')); ?>"/>
                                    </div>
                                </div>

                                <div class="control-group">
                                    <label for="usage_per_customer"><?php echo e(__('admin::app.promotions.cart-rules.uses-per-customer')); ?></label>
                                    <input class="control" id="usage_per_customer" name="usage_per_customer" value="<?php echo e(old('usage_per_customer')); ?>"/>
                                ...
                                <div class="control-group date">
                                    ...
                                    <datetime>
                                        <input type="text" name="ends_till" class="control" value="<?php echo e(old('ends_till')); ?>"/>
                                    </datetime>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin::layouts.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\velocity_new_app\packages\Webkul\Admin\src\Providers/../Resources/views/promotions/cart-rules/create.blade.php ENDPATH**/ ?>